        ...
        if (chat.welcome) {
          ...
          for (let user of participants) {
            ...
            try {
              ...
              let { key } = await this.sendButtonLoc(jid, await (await fetch('https://telegra.ph/file/776553bc80162ef318c55.jpg')).buffer(), text, '©HamzzBot By Hamzz', action === 'add' ? 'Welcome' : 'Goodbye', '©HamzzBot By HamzzBot')
            }
          }
        }
        break
...
global.dfail = (type, m, conn) => {
  ...
  let msg = {
    rowner: ' _*perintah ini hanya dapat digunakan oleh @6285826114932*_',
    owner: ' _*perintah ini hanya dapat digunakan oleh @6285826114932*_',
    mods: 'Perintah ini hanya dapat digunakan oleh _*Moderator*_ !',
    premium: 'Perintah ini hanya untuk member _*Premium*_ ! beli _*Premium*_ ketik !price',
    group: 'Perintah ini hanya dapat digunakan di grup!',
    private: 'Perintah ini hanya dapat digunakan di Chat Pribadi!',
    admin: 'Perintah ini hanya untuk *Admin* grup!',
    nsfw: 'Perintah ini hanya bisa diaktifkan oleh owner',
    botAdmin: 'Jadikan bot sebagai *Admin* untuk menggunakan perintah ini!',
    unreg: '── 「 NOT REGISTERED 」 ──\nSilakan Register Terlebih Dahulu Sebelum Menggunakan Bot. Cara Register Cukup Dengan Command  *#daftar namamu.umurmu*\n\nNote:\nHarap Save Serial Number Mu Agar Bisa Melakukan Unreg Database Bot', 
  }[type]
